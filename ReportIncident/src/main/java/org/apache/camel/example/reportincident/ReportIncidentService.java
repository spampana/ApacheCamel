 ...
 * 2014-02-07T14:47:53.995+05:30
 * Generated source version: 2.6.1
 * 
 */
@WebServiceClient(name = "ReportIncidentService", 
                  wsdlLocation = "file:/D:/119063/ProjectWorkspacecsp2/ReportIncident/src/main/webapp/WEB-INF/report_incident.wsdl",
...
public class ReportIncidentService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/119063/ProjectWorkspacecsp2/ReportIncident/src/main/webapp/WEB-INF/report_incident.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ReportIncidentService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/D:/119063/ProjectWorkspacecsp2/ReportIncident/src/main/webapp/WEB-INF/report_incident.wsdl");
        }
        WSDL_LOCATION = url;
    }
